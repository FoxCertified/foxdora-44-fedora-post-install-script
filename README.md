...
git remote add origin https://gitlab.com/fox-does-stuff/foxdora-44-post-install-script.git
...
* [Set up project integrations](https://gitlab.com/fox-does-stuff/foxdora-44-post-install-script/-/settings/integrations)
